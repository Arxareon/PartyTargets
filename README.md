# <img src="https://wago-addons.ams3.digitaloceanspaces.com/thumbnails/CmtzQg7JfpeZBchDcOx4qF7mUz5QaCCJrf22knx4.png" alt="Party Targets Logo" width="40" height="40" align="top"> Party Targets
...
## Features
* See who your party and raid members are targeting, and what health are they at - useful in Arena & Battlegrounds!

### Support

Alongside the one-time & monthly donation options featured above, watching ads on [**CurseForge**](https://www.curseforge.com/wow/addons/party-targets-addon) or [**Wago**](https://addons.wago.io/addons/party-targets) also supports my work. You can keep up to date via the CurseForge or Wago App *as well as **[WoWUP](https://wowup.io/)** if you enable CurseForge or Wago.io as an addon provider*.
